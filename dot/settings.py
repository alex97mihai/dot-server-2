...
SECRET_KEY = '$xb$nl74v0yk)n4reetugzbty*)+l#rsnjs=2ego0-jqb60erh'
...
MEDIA_URL = '/media/'
MEDIA_ROOT = '/home/ubuntu/dot_django/media/'
...
CELERY_IMPORTS=('dot_basic.tasks')
CELERY_TIMEZONE = 'Europe/London'
CELERY_BEAT_SCHEDULE = { 'exchange_celery': {
        'task': 'dot_basic.tasks.exchange_celery',
